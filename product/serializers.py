...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Product
        fields=['id','name','price','stock','color','size','description','category','price_with_tex','images']
...
class SimplerUserSerializers(serializers.ModelSerializer):
...
class ReviewSerializers(serializers.ModelSerializer):
    ...
    def get_user(self,obj):
        return SimplerUserSerializers(obj.user).data
